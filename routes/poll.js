...
router.get('/create', (req, res) => {
    res.render('poll/create'); // Assuming you have a view file named create.ejs for poll creation
});
...
router.post('/create', async (req, res) => {
    ...
    try {
        ...
        res.status(500).render('poll/create', { error: 'An error occurred. Please try again.' });
    }
});
